...
variable "role_name" {
  description = "The IAM Role name created for the lambda function.  By specifying the name, circular references can be avoided when calling resources requiring the lambda ARN also need the role ARN."
  default     = ""
  type        = string
}
